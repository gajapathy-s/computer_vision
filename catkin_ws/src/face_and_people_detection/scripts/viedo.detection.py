...
class LoadVideo(object):
    ...
    def video_detection (self,):
        ...
        face_cascade = cv2.CascadeClassifier("/home/user/catkin_ws/src/face_and_people_detection/haar_cascades/frontalface.xml")
        eyes_cascade = cv2.CascadeClassifier("/home/user/catkin_ws/src/face_and_people_detection/haar_cascades/eye.xml")
        ScaleFactor = 1.2
